...
Defined in: [types/camera.ts:381](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/camera.ts#L381)
...
Defined in: [types/camera.ts:390](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/camera.ts#L390)
