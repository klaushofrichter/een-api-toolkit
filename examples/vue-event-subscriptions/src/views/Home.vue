...
<template>
  <div class="home">
    <h2>Welcome to the Event Subscriptions Example</h2>
    ...
    <div v-else class="authenticated">
      ...
      <div class="actions">
        ...
        <router-link to="/live">
          <button class="secondary">View Live Events</button>
        </router-link>
      </div>
    </div>
    ...
    <div class="description">
      ...
      <p>
        This example demonstrates how to use the Event Subscriptions API
        from the EEN API Toolkit to create SSE subscriptions and receive
        real-time events from cameras.
      </p>
      <h4>Features</h4>
      <ul>
        <li>Create and delete event subscriptions</li>
        <li>View active subscriptions with pagination</li>
        <li>Connect to SSE streams for live events</li>
        <li>Select cameras and event types for filtering</li>
        <li>Real-time event display</li>
      </ul>
