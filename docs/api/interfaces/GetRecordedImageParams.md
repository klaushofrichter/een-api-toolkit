...
Defined in: [src/types/media.ts:179](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L179)
...
Defined in: [src/types/media.ts:202](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L202)
