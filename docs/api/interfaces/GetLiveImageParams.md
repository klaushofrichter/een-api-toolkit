...
Defined in: [types/media.ts:133](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L133)
...
Defined in: [types/media.ts:135](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L135)
