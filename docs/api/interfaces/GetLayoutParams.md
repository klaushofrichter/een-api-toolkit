...
Defined in: [src/types/layout.ts:278](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/layout.ts#L278)
...
Defined in: [src/types/layout.ts:280](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/layout.ts#L280)
