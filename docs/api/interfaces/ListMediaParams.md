...
Defined in: [src/types/media.ts:80](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L80)
...
Defined in: [src/types/media.ts:97](https://github.com/klaushofrichter/een-api-toolkit/blob/production/src/types/media.ts#L97)
