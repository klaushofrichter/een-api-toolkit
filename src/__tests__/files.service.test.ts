...
describe('Files service functions', () => {
  ...
  describe('listFiles', () => {
    ...
    it('should fetch files successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://api.c001.eagleeyenetworks.com/api/v3.0/files',
    ...
    it('should include pagination parameters in request', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://api.c001.eagleeyenetworks.com/api/v3.0/files?pageSize=100&pageToken=page-xyz',
        expect.any(Object)
      )
    })
  ...
  describe('getFile', () => {
    ...
    it('should fetch file by ID successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://api.c001.eagleeyenetworks.com/api/v3.0/files/file-123',
        expect.objectContaining({
          method: 'GET',
          headers: {
            'Accept': 'application/json',
  ...
  describe('downloadFile', () => {
    ...
    it('should download file successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://api.c001.eagleeyenetworks.com/api/v3.0/files/file-123:download',
        expect.objectContaining({
          method: 'GET',
          headers: {
            'Authorization': 'Bearer test-token'
  ...
  describe('deleteFile', () => {
    ...
    it('should encode fileId with special characters', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://api.c001.eagleeyenetworks.com/api/v3.0/files/file%2F123',
        expect.any(Object)
      )
    })
