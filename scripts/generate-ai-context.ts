...
// =============================================================================
// AI-PTZ.md (PTZ Camera Controls)
// =============================================================================

function generatePtzDoc(config: GeneratorConfig): string {
  const ptzExample = extractVueComponent(path.join(EXAMPLES_DIR, 'vue-ptz/src/views/PtzControl.vue'))
  const directionPad = extractVueScript(path.join(EXAMPLES_DIR, 'vue-ptz/src/components/DirectionPad.vue'))

  return generateVersionHeader(
    'PTZ Camera Controls',
    config.version,
...
${generateCrossReferences(['AI-AUTH.md', 'AI-DEVICES.md', 'AI-MEDIA.md'])}
`
}
...
function main() {
  ...
  if (singleFile) {
    ...
    const docs = [
      ...
      { name: 'AI-PTZ.md', generator: generatePtzDoc }
    ]
