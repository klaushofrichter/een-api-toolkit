...
function generateHlsTroubleshooting(): string {
  return `## HLS Video Playback Troubleshooting
...
function main() {
  ...
  const content = [
    ...
    generateUtilities(),            // Utility functions (formatTimestamp, etc.)
    generateLiveVideoStreaming(),   // Live video streaming guide
    generateHlsTroubleshooting(),   // HLS video troubleshooting guide
    generatePatterns(),
